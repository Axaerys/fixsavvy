const PackageCard = ({ color, altColor, title, li1, li2, li3, price }) => {
  return (
    <section className="min-h-[30rem] w-[23%] max-lg:w-[48%] max-lg:my-[2%] max-md:w-full max-md:mb-8 rounded-3xl border-[2px] border-gray-200 shadow-lg px-6 py-6 hover:scale-105 td">
